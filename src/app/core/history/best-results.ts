 ...
 */
export function bestResults(records: AthleteRecord[], { gender, year }: { gender: GenderType; year: string | null }): BestResult[] {
  return records
 ...
 */
export function bestSeasonResults(
  records: AthleteRecord[],
  { gender, year, season }: { gender: GenderType; year: string; season: SeasonType },
): BestResult[] {
  return records
    .reduce<BestResult[]>((results, record) => {
...
function toBestResult(record: AthleteRecord, { bestMs, year }: { bestMs: number; year: string | null }): BestResult {
