...
const run = (
  athleteKey: string,
  { dateIso, timeMs, slug = dateIso }: { dateIso: string; timeMs: number; slug?: string },
): ParticipantRun => ({
  athleteKey,
  dateIso,
  slug,
...
const eventRun = (athleteKey: string, timeMs: number): ParticipantRun =>
  run(athleteKey, { dateIso: NOTABLE_EVENT_DATE, timeMs, slug: NOTABLE_EVENT_SLUG });
...
export const NOTABLE_EVENT_RUNS: ParticipantRun[] = [
  ...
  run(SECOND_RANK_KEY, { dateIso: '2025-05-04', timeMs: 1440000 }),
  run(SECOND_RANK_KEY, { dateIso: '2025-06-01', timeMs: 1560000 }),
  run(SECOND_RANK_KEY, { dateIso: '2025-07-06', timeMs: 1560000 }),
  run(SECOND_RANK_KEY, { dateIso: '2025-08-03', timeMs: 1560000 }),
  run(SECOND_RANK_KEY, { dateIso: '2026-02-01', timeMs: 1560000 }),
  run(SECOND_RANK_KEY, { dateIso: '2026-07-05', timeMs: 1300000 }),
  eventRun(SECOND_RANK_KEY, 1500000),
  // Rank 3 of exactly five career runs — the minimum history that still ranks.
  run(THIRD_RANK_KEY, { dateIso: '2025-03-02', timeMs: 1400000 }),
  run(THIRD_RANK_KEY, { dateIso: '2025-04-06', timeMs: 1450000 }),
  run(THIRD_RANK_KEY, { dateIso: '2026-01-04', timeMs: 1560000 }),
  run(THIRD_RANK_KEY, { dateIso: '2026-02-01', timeMs: 1600000 }),
  eventRun(THIRD_RANK_KEY, 1500000),
  // The fastest career run: rank 1 stays silent, the stored «ЛР» note already marks it.
  run(RECORD_KEY, { dateIso: '2025-05-04', timeMs: 1560000 }),
  run(RECORD_KEY, { dateIso: '2025-06-01', timeMs: 1560000 }),
  run(RECORD_KEY, { dateIso: '2025-07-06', timeMs: 1560000 }),
  run(RECORD_KEY, { dateIso: '2025-08-03', timeMs: 1560000 }),
  eventRun(RECORD_KEY, 1500000),
  // Rank 2 of only four runs: too short to rank, and the window still holds a faster run.
  run(SHORT_HISTORY_KEY, { dateIso: '2026-01-04', timeMs: 1440000 }),
  run(SHORT_HISTORY_KEY, { dateIso: '2026-02-01', timeMs: 1560000 }),
  run(SHORT_HISTORY_KEY, { dateIso: '2026-03-01', timeMs: 1600000 }),
  eventRun(SHORT_HISTORY_KEY, 1500000),
  // Rank 4 (three faster runs live before the window), but the best of the three window runs.
  run(WINDOW_BEST_KEY, { dateIso: '2025-01-05', timeMs: 1380000 }),
  run(WINDOW_BEST_KEY, { dateIso: '2025-02-02', timeMs: 1410000 }),
  run(WINDOW_BEST_KEY, { dateIso: '2025-03-02', timeMs: 1440000 }),
  run(WINDOW_BEST_KEY, { dateIso: '2026-01-04', timeMs: 1560000 }),
  run(WINDOW_BEST_KEY, { dateIso: '2026-02-01', timeMs: 1580000 }),
  run(WINDOW_BEST_KEY, { dateIso: '2026-03-01', timeMs: 1600000 }),
  eventRun(WINDOW_BEST_KEY, 1500000),
  // Beats the window, but two runs of company are one short of the threshold.
  run(THIN_WINDOW_KEY, { dateIso: '2025-01-05', timeMs: 1380000 }),
  run(THIN_WINDOW_KEY, { dateIso: '2025-02-02', timeMs: 1410000 }),
  run(THIN_WINDOW_KEY, { dateIso: '2025-03-02', timeMs: 1440000 }),
  run(THIN_WINDOW_KEY, { dateIso: '2026-01-04', timeMs: 1560000 }),
  run(THIN_WINDOW_KEY, { dateIso: '2026-02-01', timeMs: 1560000 }),
  ...
  run(SHORT_COURSE_KEY, { dateIso: '2026-02-01', timeMs: 1560000 }),
];
