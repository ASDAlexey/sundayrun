...
/**
 * Builds the `data/protocol.db` entry of a publication commit: downloads the current db via the
 ...
 * state. `protocol.db` is the single source of truth now, so a download or wasm failure is not
