...
import { EXPECTED_DOC_CONTENT, PDF_EVENT_MOCK, PDF_FINISH_COUNTS_MOCK, PDF_ROWS_MOCK } from './protocol-doc-definition.mock';

describe('protocol-doc-definition', () => {
  it('builds the A4 protocol document mirroring the reference sample', () => {
    const doc = buildProtocolDocDefinition(PDF_EVENT_MOCK, PDF_ROWS_MOCK, PDF_FINISH_COUNTS_MOCK);
