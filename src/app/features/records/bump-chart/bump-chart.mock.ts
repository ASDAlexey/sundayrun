  ...
  lines: [
    {
      ...
      dots: [
        { x: 40, y: 21, label: { date: '6 апреля 2025 г.', place: '№1', time: '20:00,00' } },
        { x: 96, y: 21, label: { date: '13 апреля 2025 г.', place: '№1', time: '20:00,00' } },
        { x: 152, y: 21, label: { date: '20 апреля 2025 г.', place: '№1', time: '20:00,00' } },
      ],
      finalPlace: 1,
      labelY: 21,
      active: false,
    ...
    },
    {
      ...
      dots: [
        { x: 96, y: 47, label: { date: '13 апреля 2025 г.', place: '№2', time: '34:00,00' } },
        { x: 152, y: 47, label: { date: '20 апреля 2025 г.', place: '№2', time: '20:30,00' } },
      ],
      finalPlace: 2,
      labelY: 47,
      active: false,
...
export const EXPECTED_TOP_TOOLTIP: BumpTooltipView = {
  ...
  below: true,
  name: 'Волков Виктор',
  label: { date: '6 апреля 2025 г.', place: '№1', time: '20:00,00' },
  colorVar: 'var(--chart-1)',
};
