...
/** One card per explained feature: короли, первый круг, раскладка, обгоны второго круга, гонка за сезон, рейтинг, до следующего места, легенда, серии, раж, бейджи, итоги, дуэли, соперники, мем-пороги, форма, цифры, погода, график. */
export const EXPECTED_GUIDE_CARD_COUNT = 19;
