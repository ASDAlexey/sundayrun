...
/** One card per explained feature: короли, первый круг, раскладка, обгоны второго круга, кто чаще всех, гонка за сезон, рейтинг, до следующего места, легенда, серии, раж, бейджи, итоги, прогресс года, дуэли, соперники, мем-пороги, форма, цифры, погода, фото, график, секундомер. */
export const EXPECTED_GUIDE_CARD_COUNT = 23;
