  ...
  points: [
    {
      ...
      medianText: '24:00',
      percent: 100,
      ariaText: '4 мая 2025 г.: 24:00, 100% от пика',
      leftPercent: 1.4,
      topPercent: 6.7,
      tipBelow: true,
      tipAlign: 'start',
    ...
    },
    {
      ...
      medianText: '24:00',
      percent: 100,
      ariaText: '1 июня 2025 г.: 24:00, 100% от пика',
      leftPercent: 33.8,
      topPercent: 6.7,
      tipBelow: true,
      tipAlign: 'center',
    ...
    },
    {
      ...
      medianText: '24:00',
      percent: 100,
      ariaText: '6 июля 2025 г.: 24:00, 100% от пика',
      leftPercent: 66.2,
      topPercent: 6.7,
      tipBelow: true,
      tipAlign: 'center',
    ...
    },
    {
      ...
      medianText: '30:00',
      percent: 80,
      ariaText: '3 августа 2025 г.: 30:00, 80% от пика',
      leftPercent: 98.6,
      topPercent: 93.3,
      tipBelow: false,
      tipAlign: 'end',
  ...
  points: [
    {
      ...
      medianText: '30:00',
      percent: 100,
      ariaText: '4 мая 2025 г.: 30:00, 100% от пика',
      leftPercent: 50,
      topPercent: 50,
      tipBelow: false,
      tipAlign: 'center',
